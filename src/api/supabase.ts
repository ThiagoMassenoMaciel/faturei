...
const supabaseUrl = "https://mqdosolveajugsepozin.supabase.co"; // <-- minha URL    https://mqdosolveajugsepozin.supabase.co/rest/v1/
...
/*
"sb_publishable_GaXANE_249bN8bBLgST4uw_57gXnc5y"; // settings-apikeys- Publishable key
